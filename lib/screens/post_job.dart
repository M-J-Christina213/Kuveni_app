...
class _PostJobScreenState extends State<PostJobScreen> {
  ...
  void _postJob() async { // Made async to await Firestore operation
    if (_formKey.currentState!.validate()) {
      ...
      final newJob = Job(
        ...
        postedDate: DateTime.now(), // Set current date as posted date
      );

      try {
        // Get a reference to the Firestore 'jobs' collection
        CollectionReference jobs = FirebaseFirestore.instance.collection('jobs');

        // Add the new job to Firestore
        await jobs.add(newJob.toFirestore()); // Use the toFirestore method from your Job model
